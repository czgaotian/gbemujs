...
export function fetchData(this: CPU) {
  ...
  switch (this.instruction.addressMode) {
    ...
    case AM.D16:
      ...
      const hi = this.emulator.busRead(this.pc);
      this.pc++;
    ...
    case AM.R_MR:
      ...
      this.memoryDestination = this.readRegister(this.instruction.registerType2);
    ...
    case AM.R_HLI:
      ...
      this.fetchedData = this.readRegister(this.instruction.registerType2);
      this.emulator.busRead(this.memoryDestination);
      this.pc++;
      return;
    ...
    case AM.A8_R:
      this.memoryDestination = this.emulator.busRead(this.pc);
      this.destinationIsMemory = true;
      this.pc++;
      return;
    ...
    default:
      throw new Error(`Unknown Addressing Mode! ${this.instruction.addressMode} (${this.opcode})`);
  }
}
